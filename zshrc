...
alias jc="journalctl"
alias updatemirrorlist="sudo reflector -c 'United States' -p http -a 12 --sort rate --verbose --save /etc/pacman.d/mirrorlist"
...
alias k1="killall -1"
alias k9="killall -9"
alias soff="sleep 0.1 && xset dpms force standby"
alias son="xset -dpms"
